            ...
            <td class="auto-style2">
                <table style="width: 100%; height: 479px; margin-top: 0px;">
                    <tr>
                        ...
                        <td class="auto-style4" style="background-color: #F6F6F6">学号:</td>
                    ...
                    <tr>
                        <td class="auto-style6">&nbsp;</td>
                        <td class="auto-style4" style="background-color: #F6F6F6">学院:</td>
                        <td style="background-color: #F6F6F6">
                    ...
                    <tr>
                        <td class="auto-style6">&nbsp;</td>
                        <td class="auto-style4" style="background-color: #F6F6F6">专业:</td>
                        <td style="background-color: #F6F6F6">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3" style="background-color: #F6F6F6">
                            <asp:TextBox name="content1" ID="TextBox1" runat="server" Height="68px" Width="518px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style7"></td>
                        <td class="auto-style8"></td>
                        <td class="auto-style9" style="background-color: #F1F1F1">&nbsp;
